...
@section('content')
    <div class="mx-auto max-w-5xl">
        <x-admin.page-header title="Tambah Pengguna Baru"
            description="Buat akun Admin atau Staff dengan akses yang sesuai dengan kebutuhan operasional." />

        <x-admin.form-card>
            <form method="POST" action="{{ route('admin.pengguna.store') }}" class="space-y-6">
                @csrf
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    ...
                    <div>
                        <label class="mb-2 block text-sm font-semibold text-[var(--text)]">Password *</label>
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    ...
                    <div class="flex items-center gap-3 pt-8">
                        ...
                        <label for="is_active" class="text-sm font-semibold text-[var(--text)]">Aktifkan akun segera</label>
                    </div>
                </div>
